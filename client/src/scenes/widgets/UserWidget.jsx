...
import { Box, Typography, Divider, useTheme, Stack, Skeleton } from '@mui/material';
...
import UserWidgetSkeletonLoader from 'components/UserWidgetSkeletonLoader';
...
const UserWidget = ({ userId, picturePath }) => {
  ...
  if (!user) {
    return <UserWidgetSkeletonLoader />;
  }
